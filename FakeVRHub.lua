...
local A = Y.Button({
	...
	Menu = {
		Information = function(self)
			X.Banner({
				Text = "This is function is bypassing map kills."
			})
		end
	}
})
...
local A = Y.Button({
	...
	Menu = {
		Information = function(self)
			X.Banner({
				Text = "This is function is bypassing to many map kills."
			})
		end
	}
})
...
local A = Y.Button({
	Text = "Load VR (WORKING ON KEYBOARD)",
	Callback = function()
...
wait(9e9)
	...
	Menu = {
		Information = function(self)
			X.Banner({
				Text = "This is Button traveling you to fake vr or real vr."
			})
		end
	}
})
...
local A = Z.Button({
	Text = "Copy Author ds",
	Callback = function()
		local copy = "mrozyy#1983" script.parent.MouseButton1Click:Connect(function(plr) setclipboard(tostring(copy)) end)
	end,
	Menu = {
		Information = function(self)
			X.Banner({
...
local A = Z.Button({
	Text = "Made by Synapse x (click to copy)",
	Callback = function()
		local copy = "https://x.synapse.to" script.parent.MouseButton1Click:Connect(function(plr) setclipboard(tostring(copy)) end)
	end,
	Menu = {
		Information = function(self)
			X.Banner({
				Text = "Who this cheking?"
			})
		end
	}
})
...
local A = Z.Button({
	Text = "Tester mrozyy#1983",
	Callback = function()
		local copy = "Sorry dude this is easter egg" script.parent.MouseButton1Click:Connect(function(plr) setclipboard(tostring(copy)) end)
	end,
	Menu = {
		Information = function(self)
			X.Banner({
